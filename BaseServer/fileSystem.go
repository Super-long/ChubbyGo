 ...
 */
func (Fsn *FileSystemNode) Delete(InstanceSeq uint64 ,filename string) bool {
	Node := Fsn.next[filename]
	...
	if Node.OpenReferenceCount != 0 && Node.fileType == Directory{	// 引用计数对于非文件夹文件来说没有用
